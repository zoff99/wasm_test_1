...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_wasmtoxversion')) {
        Object.defineProperty(Module['ready'], '_wasmtoxversion', { configurable: true, get: function() { abort('You are getting _wasmtoxversion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_wasmtoxversion', { configurable: true, set: function() { abort('You are setting _wasmtoxversion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_wasm_new_message_id')) {
        Object.defineProperty(Module['ready'], '_wasm_new_message_id', { configurable: true, get: function() { abort('You are getting _wasm_new_message_id on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_wasm_new_message_id', { configurable: true, set: function() { abort('You are setting _wasm_new_message_id on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_wasm_tox_new')) {
        Object.defineProperty(Module['ready'], '_wasm_tox_new', { configurable: true, get: function() { abort('You are getting _wasm_tox_new on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_wasm_tox_new', { configurable: true, set: function() { abort('You are setting _wasm_tox_new on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _wasmtoxversion = Module["_wasmtoxversion"] = createExportWrapper("wasmtoxversion");

/** @type {function(...*):?} */
var _wasm_new_message_id = Module["_wasm_new_message_id"] = createExportWrapper("wasm_new_message_id");

/** @type {function(...*):?} */
var _wasm_tox_new = Module["_wasm_tox_new"] = createExportWrapper("wasm_tox_new");
